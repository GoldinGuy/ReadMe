...
const SearchComp = () => {
	...
	return (
		<div className="text-center bg-indigo-50 mt-5">
			<div className="flex inline justify-evenly mb-5 justify-center">
				{selectedBooks.map((book, index) => {
					if (index === Math.round(selectedBooks.length / 2)) {
						return (
							<>
								<button className="rounded-md px-6 h-14 bg-yellow-400 text-md md:text-lg text-gray-50">
									See My List
								</button>
								<img
									src={book.photo}
...
const ReaderImg = () => {
	return (
		<svg
			...
			// width="1022.84"
			// height="813.16"
			className="m-auto h-60 md:h-80 mt-10 md:mt-20 md:mb-20"
			// height="400px"
